  ...
  return (
    ...
    <section className="relative">
        <div className="relative z-10 p-8 md:p-12 lg:px-16 lg:py-24 text-center">
            ...
            <div className="mt-8">
                <Link to='/Flashback' className="bg-linear-to-r from-lime-500 to-green-800 text-white font-medium rounded-full px-12 py-3 inline-block text-sm hover:opacity-90 transition-transform duration-200 ease-linear hover:-translate-y-1 cursor-pointer">Go !</Link>
            </div>
        </div>
