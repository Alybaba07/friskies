  ...
  return (
    ...
    <section className="relative">
        <div className="relative z-10 p-8 md:p-12 lg:px-16 lg:py-24 text-center">
            ...
            <div className="mt-8">
                <Link to='/Wrapped2025' className="bg-linear-to-br from-lime-500 to-green-800 text-white font-medium rounded-full px-12 py-3 inline-block text-sm hover:opacity-90 hover:scale-105 transition-all cursor-pointer">Go !</Link>
            </div>
        </div>
