    ...
    <div className="bg-stone-950 min-h-screen">
      ...
      <section className="py-24 ">
          <div className="container mx-auto px-6">
              ...
              {members.map((m, i) => (
                <div key={i} className={`bg-linear-to-b from-zinc-900 via-zinc-900 ${m.color} p-8 rounded-xl cursor-pointer hover:scale-105 transition`} onClick={() => openOverlay(i)}>
              ...
              <div className="flex flex-col md:flex-row gap-10 w-full">
                ...
                <div className="basis-2/3 flex flex-col text-center md:text-left">
                  ...
                  <div className="flex flex-wrap justify-center md:justify-start gap-3 mb-6 text-xl">
                    <span className={`inline-flex gap-3 items-center rounded-full border-2 px-3 py-1 text-zinc-400`}>
