    ...
    <div className="bg-stone-950 min-h-screen">
      <Header/>
        <div className="text-stone-100 pt-[2%] pb-[2%]">
          <h3 className="p-[2%] font-bold"><u> Période des statistiques relevées </u></h3>
          <p className="pl-[2%]"> Le Flashback est un résumé chiffré du serveur. Les données ont été prises du 1er janvier 2025 à 00h00 au 30 novembre 2025 à 23h59. Le mois de décembre n'est donc <strong>pas comptabilisé</strong></p>
          <p className="pl-[2%]"> Les données vocales ont des périodes différentes et sont détaillées dans la partie <u><a href="#salons_vocaux"> Salons vocaux</a></u></p>
          
          <h3 className="p-[2%] font-bold"><u> Membres </u></h3>
          <p className="pl-[2%]"> Les membres pris en compte pour le flashback sont ceux ayant répondu au formulaire. Si vous n'êtes pas présent et aimeriez l'être, vous pouvez toujours répondre au formulaire juste <a href="https://docs.google.com/forms/d/e/1FAIpQLScYsEJCrLVeUVoU_i5HnoovWlHWHJarwSXXTmCjAFq_hYG6zg/viewform" className="underline"> ici </a></p>
          <p className="pl-[2%]"> Le classement des membres a été réalisé sur un total de 84 membres. Ce nombre a été relevé le 30 novembre à 23h59 et comptabilise <strong>bots</strong> et <strong>double compte</strong> </p>
        
        <h3 className="p-[2%] font-bold" id="salons_vocaux"><u>Salons vocaux</u></h3>
        ...
        <ul className="p-[2%]">
            <li>Du mercredi 1er janvier au samedi 1er mars inclus</li>
            <li className="text-red-700">Du dimanche 2 mars au lundi 3 mars (soit 2 jours)</li>
            <li>Du mardi 4 mars au dimanche 4 mai inclus</li>
            ...
            <li>Du mardi 26 août au dimanche 30 novembre inclus</li>
        </ul>
        </div>
