          ...
          <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 animate-fadeIn">
            <div className="relative bg-zinc-900 text-white p-10 w-[90%] h-[90%] rounded-xl shadow-xl flex flex-col items-center justify-center">
              ...
              <div className="max-w-screen-xl mx-auto px-6 md:px-10">
                      <img src={members[selectedIndex].img} className=""/>

                  <div>
                      <h1 className="text-4xl lg:text-5xl font-extrabold leading-tight mb-6">
                        {members[selectedIndex].name}
                      </h1>
                  <div className="flex flex-wrap gap-3 my-4 text-xl">
                      <span data-popover-target="popover-default" className={`inline-flex gap-3 items-center justify-center rounded-full border ${members[selectedIndex].borderColor} px-2.5 py-1 ${members[selectedIndex].textColor}`}>
                        {members[selectedIndex].roleIcon}
                        <p className="text-sm whitespace-nowrap"> {members[selectedIndex].role} </p>
                      </span>
                      <span data-popover-target="popover-default" className={`inline-flex gap-2 items-center justify-center rounded-full border border-yellow-500 px-2.5 py-0.5 text-yellow-500`}>
                        ...
                        <p className="text-sm whitespace-nowrap"> {members[selectedIndex].anniv} </p>
                      </span>
                      <span data-popover-target="popover-default" className={`inline-flex gap-2 items-center justify-center rounded-full border border-red-800 px-2.5 py-0.5 text-red-800`}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width='1em' height='1em'><path fill="currentColor" d="M19 4h-1V2h-2v2H8V2H6v2H5c-1.11 0-1.99.9-1.99 2L3 20a2 2 0 0 0 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2m0 16H5V10h14zM9 14H7v-2h2zm4 0h-2v-2h2zm4 0h-2v-2h2zm-8 4H7v-2h2zm4 0h-2v-2h2zm4 0h-2v-2h2z"/></svg>
                        <p className="text-sm whitespace-nowrap"> {members[selectedIndex].arrivee} </p>
                      </span>
                  </div>
