...
const members = [
  ...
  { name: "Amaya", img: temp, role: "Rogue", textColor: "text-zinc-400", anniv: "8 juin 2002", arrivee: "10/07/2022", desc: "Lorem Ipsum", color: "to-violet-500"},
  { name: "Ayoub", img: temp, role: "Archer", textColor: "text-zinc-400", anniv: "3 décembre 2003", arrivee: "10/07/2022", desc: "Lorem Ipsum", color: "to-purple-400"},
  ...
  { name: "Booba", img: temp, role: "Support", textColor: "text-zinc-400", anniv: "6 novembre 2000", arrivee: "10/07/2022", desc: "Lorem Ipsum", color: "to-purple-950"},
  { name: "Charlie", img: charlie, role: "Mage", textColor: "text-zinc-400", anniv: "4 juin 2004", arrivee: "10/07/2022", desc: "Lorem Ipsum", color: "to-blue-400"},
            ...
            <div className="relative bg-zinc-900 text-white p-10 w-[90%] h-[90%] rounded-xl shadow-xl flex flex-col items-center justify-center">
              ...
              <div className="max-w-screen-xl mx-auto px-6 md:px-10">
                  ...
                  <div className="flex flex-wrap gap-3 my-4 text-xl">
                      <span data-popover-target="popover-default" className={`inline-flex gap-3 items-center justify-center rounded-full border-2 border-zinc-400 px-2.5 py-1 ${members[selectedIndex].textColor}`}>
                        {members[selectedIndex].roleIcon}
                        <p className="text-sm whitespace-nowrap"> {members[selectedIndex].role} </p>
                      </span>
                      <span data-popover-target="popover-default" className={`inline-flex gap-2 items-center justify-center rounded-full border-2 border-yellow-500 px-2.5 py-0.5 text-yellow-500`}>
                      ...
                      <span data-popover-target="popover-default" className={`inline-flex gap-2 items-center justify-center rounded-full border-2 border-red-800 px-2.5 py-0.5 text-red-800`}>
